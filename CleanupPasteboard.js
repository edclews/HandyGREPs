...
var SCRIPT = {name:'CleanupPasteboard', version:'1.12'};
 		...
 		with ( dialogColumns.add().borderPanels.add().dialogColumns.add() )
 			{
   			...
   			cbKeepThreaded = checkboxControls.add( {staticLabel:__("Preserve threaded text frames")} );
  			}
		}
...
// Main process
	...
	// cleanup
	alert(__("Items removed:") + ' ' + doc.cleanOut(offsets, ui.parseMaster, ui.keepThreaded));
	}
